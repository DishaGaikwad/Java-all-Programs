...
import com.day9.comparator.MyNameComparator;

public class EmployeeDaoImpl implements EmployeeDao{
	static List<Employee>elist;
	static {
		elist=new ArrayList<>();
		elist.add(new Employee(100,"Demon",89778,LocalDate.of(2024, 01, 12)));
		elist.add(new Employee(200,"Klaus",89778,LocalDate.of(2025, 11, 12)));
		elist.add(new Employee(300,"Elija",89778,LocalDate.of(2023, 11, 12)));
		elist.add(new Employee(400,"Elena",89778,LocalDate.of(2020, 10, 12)));
		elist.add(new Employee(500,"Tyler",89778,LocalDate.of(2023,11, 12)));
	}
	@Override
